    ...
    <div className="bg-[var(--color-background)] text-[var(--color-on-surface)] font-[var(--font-body)] min-h-screen flex flex-col">
      ...
      <header className="bg-[var(--color-surface)] flex justify-between items-center px-6 h-12 w-full z-40">
        <div className="flex items-center gap-6">
          <span className="text-sm font-bold text-[var(--color-on-surface)] uppercase tracking-tighter font-[var(--font-headline)]">
      ...
      {/* header divider */}
      <div className="bg-[var(--color-surface-container-high)] h-px w-full" />

      {/* ─── Main area (sidebar + content + overlay) ──────────────── */}
      <main className="flex-1 flex overflow-hidden relative">
        {/* ── Sidebar (dimmed) ────────────────────────────────────── */}
        <aside className="hidden md:flex flex-col p-4 gap-2 bg-[var(--color-surface-container-high)] h-full w-[280px] opacity-30 pointer-events-none">
          {/* project selector */}
          ...
          <div className="font-[var(--font-body)] text-sm font-medium space-y-1">
            ...
            <div className="flex items-center gap-3 px-3 py-2 bg-[var(--color-surface)] text-[var(--color-on-surface)] rounded-lg relative before:content-[''] before:absolute before:left-[-8px] before:w-1 before:h-4 before:bg-[var(--color-primary)] before:rounded-full">
      ...
      {/* ─── Footer / Status Bar ─────────────────────────────────── */}
      <footer className="bg-[var(--color-surface)] flex items-center justify-between px-4 z-50 fixed bottom-0 left-0 w-full h-8 border-t border-[var(--color-border)] font-[var(--font-body)] text-xs tracking-tight">
        <div className="flex items-center gap-3">
          <span className="text-[var(--color-text-secondary)]">
            {mockStatusBar.user} &bull; {mockStatusBar.username} &bull; {mockStatusBar.plan}
          </span>
          <div className="flex items-center gap-4 ml-4">
            <span className="text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-container-high)] px-2 py-0.5 rounded cursor-pointer transition-colors">
